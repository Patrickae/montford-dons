class WeeksController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @week.update(week_params)
        format.html { redirect_to @week, notice: "Week was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to weeks_path, notice: "Week was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_week
      @week = Week.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def week_params
      params.expect(week: [ :date, :opponent, :lanes ])
    end
end
