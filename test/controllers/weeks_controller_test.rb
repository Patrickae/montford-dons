...
class WeeksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create week" do
    assert_difference("Week.count") do
      post weeks_url, params: { week: { date: @week.date, lanes: @week.lanes, opponent: @week.opponent } }
    end
  ...
  test "should update week" do
    patch week_url(@week), params: { week: { date: @week.date, lanes: @week.lanes, opponent: @week.opponent } }
