...
class ChargeTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge_type" do
    assert_difference("ChargeType.count") do
      post charge_types_url, params: { charge_type: { amount: @charge_type.amount, frequency: @charge_type.frequency, name: @charge_type.name } }
    end
  ...
  test "should update charge_type" do
    patch charge_type_url(@charge_type), params: { charge_type: { amount: @charge_type.amount, frequency: @charge_type.frequency, name: @charge_type.name } }
